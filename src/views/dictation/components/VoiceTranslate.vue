...
const APPID = "f17e53d0"; // TODO 你的讯飞模型APPID
const API_SECRET = "MmNkMjBkZDFiY2RjMGU5ZjdkYTVjMDBh"; // TODO 你的讯飞模型API_SECRET
const API_KEY = "f90a475bbf4eac0d8eb57524cbed229e"; // TODO 你的讯飞模型API_KEY
let iatWS; //监听录音的变量
