...
import { teacherSavePaperInfoAPI } from "@/apis/paper";
...
const save = async () => {
  if (paperData.value.title.trim() === "") {
    ElMessage.error("您还未设置题目");
    return;
  }

  let score = questionList.value.reduce((accumulator, question) => {
