            ...
            <div class="right">
                ...
                <div class="questionsDetails" v-if="questionsContentList.length > 0">
                    <div class="deleteButton">
                        <el-button style="font-size: 20px; border-radius: 0 5px 0 10px; width: 50px" type="primary"
                    ...
                    <div class="questionContent">
                        ...
                        <div v-if="questionsContentList[activeListIndex].type === '单选题'" class="radio">
                            <el-radio-group v-model="questionsContentList[activeListIndex].answer" size="large">
                                <div class="radioOptions" v-for="(option, optionIndex) in JSON.parse(
                                    ...
                                    <el-radio-button style="border-radius: 20px"
                                    ...
                                    <el-button :icon="Delete" @click="deleteRadioOption(optionIndex)"
                                        style="margin-left: 20px" type="primary" text="primary"></el-button>
                                </div>
                            </el-radio-group>
                        ...
                        " class="checkBox">
                            <el-checkbox-group v-model="checkBoxAnswer" size="large">
                                <div class="checkBoxOptions" v-for="(option, optionIndex) in JSON.parse(
                                    ...
                                    <el-button :icon="Delete" @click="deleteCheckBoxOption(optionIndex)"
                                        style="margin-left: 20px" type="primary" text="primary"></el-button>
                                </div>
                            </el-checkbox-group>
                            <el-button type="primary" text="primary" :icon="Plus" style="margin-bottom: 20px"
                        ...
                        " class="fill">
                            <div class="fillOptions" v-for="(option, optionIndex) in JSON.parse(
                                ...
                                <el-button :icon="Delete" @click="deleteFillOption(optionIndex)"
                                    style="margin-left: 20px" type="primary" text="primary"></el-button>
                            </div>
                        ...
                        " class="reply">
                            ...
                            <div class="replyOptions" style="margin-bottom: 20px; margin-top: 20px">
                                <div style="" class="editor">
                                    <myEditor :text="questionsContentList[activeListIndex].answer" ref="replyAnswer">
                                    </myEditor>
                                </div>
                            </div>
                        </div>
    ...
    <el-dialog v-model="dialogFormVisible" title="发布作业" width="640">
        <el-form :model="publishSetting">
            ...
            <el-form-item label="有效时段">
                <el-date-picker v-model="publishSetting.beginDate" type="datetime" placeholder="开始时间"
                    style="margin-right: 20px" value-format="YYYY-MM-DD HH:mm:ss" />
                至
                <el-date-picker v-model="publishSetting.endDate" type="datetime" placeholder="结束时间"
                    style="margin-left: 20px" value-format="YYYY-MM-DD HH:mm:ss" />
            </el-form-item>
        </el-form>
        <template #footer>
